...
echo ""
echo "     ws new feature-123 app libs/common       # crear workspace"
echo "     ws list                                  # listar workspaces"
echo "     ws cd feature-123                        # cambiar a workspace"
echo "     ws add feature-123 libs/utils            # añadir repo"
echo "     ws clean feature-123                     # limpiar workspace"
echo ""
echo "   💡 Soporta abreviaturas:"
echo "     ws n feature-123 app        # ws new"
echo "     ws ls                        # ws list"
echo "     ws cd feature-123            # cambia automáticamente"
echo "     ws rm feature-123            # ws clean"
echo ""
echo "   💡 Soporta búsqueda parcial:"
echo "     ws cd feat       # busca 'feat' en workspaces"
echo "     ws add 123 ...   # busca '123' en workspaces"
echo ""
